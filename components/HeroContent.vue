<template>
  <div class="relative size-full">
    <!-- Main content -->
    <div class="relative flex flex-col gap-6 items-center justify-start w-[1026px]" style="z-index:1;">
      <!-- Title and subtitle -->
    ...
    Dart-Native
      ...
      <!-- Buttons -->
      <div class="flex gap-6 items-end justify-start w-[503.135px]">
        <div class="flex flex-col gap-2 items-start justify-start w-[243px]">
          <p class="font-sans font-medium text-[14px] text-[#dedede] text-center w-full">
            Valid till 15th September,2025
          </p>
          <button class="bg-[#f9a71e] px-6 py-3 rounded-[8px] shadow-[0px_0px_10px_10px_rgba(0,0,0,0.05)] w-full">
            <span class="font-sans font-semibold text-[22px] text-transparent bg-clip-text text-gradient-hero">
              Get Access
            </span>
          </button>
        </div>
...
<script setup>
// Hero content component - can be reused or extracted from HeroSection
</script>
